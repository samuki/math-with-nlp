#!/bin/bash
#
#SBATCH --job-name=arithmetic_div
#SBATCH --output=train_logs/arithmetic_div_out.txt
#SBATCH --ntasks=1
#SBATCH --mem=64G
#SBATCH --partition=single
#SBATCH --time=2-0:00:00
#SBATCH -e train_logs/arithmetic_div_error.txt
...
srun python code/main.py --config configs/arithmetic__div_hard.yaml
