#!/bin/bash
#
#SBATCH --job-name=arithmetic_1
#SBATCH --output=train_logs/arithmetic_1_out.txt
#SBATCH --ntasks=1
#SBATCH --mem=64G
#SBATCH --partition=single
#SBATCH --time=2-0:00:00
#SBATCH -e train_logs/arithmetic_1_error.txt
...
srun python code/main.py --config configs/arithmetic__add_or_sub_hard.yaml
